...
det.cont:                                         ; preds = %det.achd, %if.end
  ...
  %sub1 = sub nsw i64 %5, 2
  detach within %syncreg, label %det.achd2, label %det.cont4
...
det.cont8:                                        ; preds = %det.achd6, %sync.continue
  ...
  detach within %syncreg, label %det.achd10, label %det.cont12
...
det.achd10:                                       ; preds = %det.cont8
  ...
  reattach within %syncreg, label %det.cont12
...
sync.continue13:                                  ; preds = %det.cont12
  ...
  sync within %syncreg, label %sync.continue15

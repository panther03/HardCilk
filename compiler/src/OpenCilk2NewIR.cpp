...
class Stmt2IRVisitor : public clang::StmtVisitor<Stmt2IRVisitor> {
  ...
  public:
    ...
    void VisitCilkSyncStmt(CilkSyncStmt *Node) {
      ...
      CurrB->pushStmtBack((IRStmt*)SyncS);
    }
...
class FinalizeVisitor: public IRExprVisitor {
  FunLookupTy &FunLookup;
public:
...
void OpenCilk2NewIR(IRProgram &P, clang::ASTContext *Context, SourceManager &SM, NullStmt &Sentinel) {
